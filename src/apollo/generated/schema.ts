...
export type GetUpcomingLaunchesListQueryVariables = Exact<{
  limit: Scalars['Int'];
  offset: Scalars['Int'];
}>;


export type GetUpcomingLaunchesListQuery = { __typename?: 'Query', launchesUpcoming: Array<{ __typename?: 'Launch', id: string | null, mission_name: string | null, details: string | null, launch_date_utc: any | null, launch_success: boolean | null, links: { __typename?: 'LaunchLinks', mission_patch_small: string | null } | null } | null> | null };
...
export type LaunchesListQuery = { __typename?: 'Query', launches: Array<{ __typename?: 'Launch', id: string | null, mission_name: string | null, details: string | null, launch_date_utc: any | null, launch_success: boolean | null, links: { __typename?: 'LaunchLinks', mission_patch_small: string | null } | null } | null> | null };

export type GetLaunchpadsListQueryVariables = Exact<{
  limit: Scalars['Int'];
  offset: Scalars['Int'];
}>;


export type GetLaunchpadsListQuery = { __typename?: 'Query', launchpads: Array<{ __typename?: 'Launchpad', attempted_launches: number | null, details: string | null, id: string | null, name: string | null, status: string | null, successful_launches: number | null, wikipedia: string | null, location: { __typename?: 'Location', name: string | null } | null } | null> | null };
...
export const GetUpcomingLaunchesListDocument = gql`
    query getUpcomingLaunchesList($limit: Int!, $offset: Int!) {
...
/**
 * __useGetUpcomingLaunchesListQuery__
 *
 * To run a query within a React component, call `useGetUpcomingLaunchesListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUpcomingLaunchesListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUpcomingLaunchesListQuery({
 *   variables: {
 ...
 * });
 */
export function useGetUpcomingLaunchesListQuery(baseOptions: Apollo.QueryHookOptions<GetUpcomingLaunchesListQuery, GetUpcomingLaunchesListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUpcomingLaunchesListQuery, GetUpcomingLaunchesListQueryVariables>(GetUpcomingLaunchesListDocument, options);
      }
export function useGetUpcomingLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUpcomingLaunchesListQuery, GetUpcomingLaunchesListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUpcomingLaunchesListQuery, GetUpcomingLaunchesListQueryVariables>(GetUpcomingLaunchesListDocument, options);
        }
export type GetUpcomingLaunchesListQueryHookResult = ReturnType<typeof useGetUpcomingLaunchesListQuery>;
export type GetUpcomingLaunchesListLazyQueryHookResult = ReturnType<typeof useGetUpcomingLaunchesListLazyQuery>;
export type GetUpcomingLaunchesListQueryResult = Apollo.QueryResult<GetUpcomingLaunchesListQuery, GetUpcomingLaunchesListQueryVariables>;
export const LaunchesListDocument = gql`
    query LaunchesList($limit: Int!, $offset: Int!) {
...
export function useLaunchesListQuery(baseOptions: Apollo.QueryHookOptions<LaunchesListQuery, LaunchesListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LaunchesListQuery, LaunchesListQueryVariables>(LaunchesListDocument, options);
      }
export function useLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchesListQuery, LaunchesListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LaunchesListQuery, LaunchesListQueryVariables>(LaunchesListDocument, options);
        }
...
export const GetLaunchpadsListDocument = gql`
    query GetLaunchpadsList($limit: Int!, $offset: Int!) {
...
/**
 * __useGetLaunchpadsListQuery__
 *
 * To run a query within a React component, call `useGetLaunchpadsListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLaunchpadsListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLaunchpadsListQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetLaunchpadsListQuery(baseOptions: Apollo.QueryHookOptions<GetLaunchpadsListQuery, GetLaunchpadsListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLaunchpadsListQuery, GetLaunchpadsListQueryVariables>(GetLaunchpadsListDocument, options);
      }
export function useGetLaunchpadsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLaunchpadsListQuery, GetLaunchpadsListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLaunchpadsListQuery, GetLaunchpadsListQueryVariables>(GetLaunchpadsListDocument, options);
        }
export type GetLaunchpadsListQueryHookResult = ReturnType<typeof useGetLaunchpadsListQuery>;
export type GetLaunchpadsListLazyQueryHookResult = ReturnType<typeof useGetLaunchpadsListLazyQuery>;
export type GetLaunchpadsListQueryResult = Apollo.QueryResult<GetLaunchpadsListQuery, GetLaunchpadsListQueryVariables>;
...
const FileSVG: React.FC = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#fae500" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" >
